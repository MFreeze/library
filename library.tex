...
%\usepackage{fullpage}
\ifthenelse{\isundefined{\bpresentation}}{
...
\usepackage[ruled,noend,noline,french]{algorithm2e}
...
% <<< MACROS DIVERSES
\newcommand{\npc}[0]{\textbf{NP}-complet}
\newcommand{\npcude}[0]{\textbf{NP}-complétude}
\newcommand{\npd}[0]{\textbf{NP}-difficile}
...
\newcommand{\fde}[0]{front d'événements}
\newcommand{\fdep}[1]{\mathcal{F}^{#1}}

% >>>
% <<< NOM DE PROBLEMES
\newcommand{\hcycle}{{\rmfamily\textsc{Hamiltonian Cycle}}}
\newcommand{\phcycle}[1]{{\rmfamily\textsc{Hamiltonian Cycle }}paramétré par \textsc{#1}}
\newcommand{\vcover}{{\rmfamily\textsc{Vertex Cover}}}
\newcommand{\twidth}{{\rmfamily\textsc{Tree Width}}}
\newcommand{\wiset}{{\rmfamily\textsc{Weighted Independant Set}}}
\newcommand{\fvset}{{\rmfamily\textsc{Feedback Vertex Set}}}
\newcommand{\kvcover}{{\rmfamily\textsc{K-Vertex Cover}}}
\newcommand{\lpath}{{\rmfamily\textsc{Longest Path}}}

\newcommand{\fisched}{{\rmfamily\textsc{Flexible Interval Scheduling}}}
\newcommand{\fischedpi}{{\rmfamily\textsc{Decision Flexible Interval Scheduling}}}
\newcommand{\unitfischedpi}{{\rmfamily\textsc{Decision Unit Flexible Interval Scheduling}}}
\newcommand{\unitfisched}{{\rmfamily\textsc{Unit Flexible Interval Scheduling}}}
\newcommand{\disunitfisched}{{\rmfamily\textsc{Disjoint Unit Flexible Interval Scheduling}}}
\newcommand{\disunitfischedpi}{{\rmfamily\textsc{Decision Disjoint Unit Flexible Interval Scheduling}}}
\newcommand{\unitevenfisched}{{\rmfamily\textsc{Unit Even Flexible Interval Scheduling}}}
\newcommand{\unitevenfischedpi}{{\rmfamily\textsc{Decision Unit Even Flexible Interval Scheduling}}}

\newcommand{\precolor}{{\rmfamily\textsc{Precoloring Extension}}}
\newcommand{\unitprecolor}{{\rmfamily\textsc{Precoloring Extension on Proper Interval Graph}}}
\newcommand{\isched}{{\rmfamily\textsc{Interval Scheduling}}}
\newcommand{\bisched}{{\rmfamily\textsc{Basic Interval Scheduling}}}
\newcommand{\isma}{{\rmfamily\textsc{Interval Scheduling with Machine Availabilities}}}
\newcommand{\binpack}{{\rmfamily\textsc{Bin Packing}}}
\newcommand{\gapsched}{{\rmfamily\textsc{Gap Scheduling}}}

\newcommand{\ufsp}{{\rmfamily\textsc{Unit FSP}}}
\newcommand{\dufsp}{{\rmfamily\textsc{Disjoint Unit FSP}}}
